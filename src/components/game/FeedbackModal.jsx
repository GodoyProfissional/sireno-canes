    ...
    >
      ...
      >
        ...
        <div className="text-center mt-6">
          ...
          <div
            id="feedback-message"
            className="text-gray-600 dark:text-gray-300 mb-8 text-base md:text-lg leading-relaxed text-left"
            role="status"
            aria-live="polite"
          >
            {renderExplanation()}
          ...
          <button
            ...
            aria-label={
              isCorrect ? 'Próxima pergunta' : lives <= 0 ? 'Perdeu vidas' : 'Tentar novamente'
            }
          >
            {isCorrect ? (
              <>
                Próxima Pergunta <ArrowRight size={24} aria-hidden="true" />
              </>
            ) : lives <= 0 ? (
              <>
                Perdeu Vidas <AlertCircle size={24} aria-hidden="true" />
              </>
            ) : (
              <>
                Tentar Novamente <ArrowRight size={24} aria-hidden="true" />
              </>
            )}
          </button>
        </div>
