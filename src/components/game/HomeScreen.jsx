...
export const HomeScreen = ({ onStart, onContinue, hasProgress }) => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen w-full max-w-4xl mx-auto px-4 py-8 text-center">
        {/* SIRENO */}
        <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full bg-red-500/10 backdrop-blur-sm flex items-center justify-center shadow-2xl border-4 border-white/20 dark:border-gray-800/30 overflow-hidden group">
          <div className="absolute inset-0 bg-red-500/5 group-hover:bg-red-500/15 transition-colors duration-300"></div>
          <img
            src={sirenoHome}
            alt="Sireno - Mascote da segurança"
            className="w-full h-full object-cover relative z-10 scale-90 group-hover:scale-95 transition-transform duration-300"
          />
        </div>

        <div className="space-y-4 mt-6">
          <div className="inline-block px-4 py-1 rounded-full bg-gray-900/80 backdrop-blur-sm text-sm font-bold text-white/90 tracking-widest uppercase border border-white/10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight leading-tight drop-shadow-xl">
            ...
            <span className="bg-clip-text bg-gradient-to-r from-primary-400 to-blue-400 text-3xl md:text-5xl drop-shadow-lg">
              Escape da Unidade
            </span>
          </h1>
